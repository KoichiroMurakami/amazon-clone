      ...
      <div class="row">
        ...
        <div class="col-xl-8 col-lg-9 col-md-12">
          ...
          <div class="orderContent">
              ...
              <div class="row">
                ...
                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2">
                  <div class="a-row">
                    ...
                    <br>
                    <span class="a-size-base a-text-bold a-color-secondary">${{ getCartTotalPriceWithShipping }}</span>
                  </div>
                </div>
            ...
            <!-- Orders body -->
            <div v-for="order in orders" :key="order._id" class="orderContentBodyAlt">
              <div class="a-row">
                <h1
...
export default {
  ...
  computed: {
    ...mapGetters(['getCartTotalPriceWithShipping'])
  }
}
</script>
