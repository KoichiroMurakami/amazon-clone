...
export default {
  ...
  computed: {
    ...mapGetters(['getCart', 'getCartLength', 'getCartTotalPriceWithShipping', 'getEstimatedDelivery'])
  },
  mounted () {
    // eslint-disable-next-line no-undef
    this.stripe = Stripe('pk_test_51IG2QZLHSxIJoOEhF9ARv56o48GZxrfDWvlDjxLx9g8hya0UOfq7ujN1X4pELPFNIdc0TF27C2UPbx0jQ2NJPjWh00MfVDUsge')
